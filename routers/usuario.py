...
async def create_usuario(
    ...
    nuevo_usuario = await usuario_service.create_usuario(usuario=usuario, db=db)
...
async def read_all_usuarios(
    ...
    usuario_service = usuario_service(db)
    usuarios = await usuario_service.get_all_usuarios()
    return usuarios
